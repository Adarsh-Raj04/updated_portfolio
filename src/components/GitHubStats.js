...
export default function GitHubStats() {
    ...
    const stats = [
        { icon: Code, label: 'Public Repos', value: animatedStats.repos || 0, color: 'text-cyan-400' },
        { icon: Users, label: 'Followers', value: animatedStats.followers || 0, color: 'text-purple-400' },
        { icon: GitBranch, label: 'Following', value: animatedStats.following || 0, color: 'text-pink-400' },
        { icon: BookOpen, label: 'Public Gists', value: animatedStats.gists || 0, color: 'text-green-400' }
    ];

    return (
        <section ref={sectionRef} id="github" className="py-32 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
                ...
                {loading ? (
                    ...
                    <div className="space-y-12">
                        ...
                        {/* PROFILE CARD */}
                        <div className={`gradient-border rounded-xl p-8 ${isVisible ? 'fade-in-up' : 'opacity-0'}`}>
                            <div className="flex flex-col md:flex-row items-center gap-8">
                                ...
                                <div>
                                    <h3 className="font-orbitron text-3xl font-bold">{githubData.name}</h3>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {stats.map((stat, i) => (
                                ...
                                >
                                    ...
                                    <p className="font-orbitron text-4xl font-bold">{stat.value}</p>
