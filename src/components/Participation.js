...
export default function Participation() {
  const participations = [
    {
      ...
      description:
        "Developed an AI-powered solution for real-time file data detection, classification and retension and strategy.",
      technologies: [
        "Python",
        "OpenAI",
        "React",
    ...
    },
    {
      ...
      description:
        "Participated in an open initiative to build innovative solutions for mobility issues. Proposed solutions across 3 tracks: Future of Mobility, Driver Enablement, and Namma Yatri platform, focusing on improving transportation efficiency, affordability, and sustainability.",
      technologies: [
        "Python",
        "Data Analysis",
        "Problem Solving",
    ...
    },
    {
      ...
      achievement: "Participant",
      description:
        "Participated in IBM Hack Challenge 2022, a hackathon organized by IBM. Explored various IBM technologies and tools, and learned about cloud computing, artificial intelligence, and data analytics.",
  ...
  return (
    <section
      id="participation"
      className="py-32 bg-gradient-to-b from-[#0f172a]/50 to-transparent relative"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {participations.map((hackathon, index) => (
            ...
            >
              {/* Icon */}
              <div
                className={`w-16 h-16 rounded-xl bg-gradient-to-br ${hackathon.color} flex items-center justify-center mb-6 group-hover:shadow-lg group-hover:shadow-blue-500/30 transition-shadow`}
              >
                {hackathon.icon}
              </div>
              ...
              {/* Achievement badge */}
              <div
                className={`font-space text-sm font-semibold mb-4 ${hackathon.achievementColor}`}
              >
              ...
              <div className="border-t border-gray-700 pt-4 mb-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="font-space text-xs text-gray-400 tracking-wider">
                    TECHNOLOGIES
                  </span>
                </div>
